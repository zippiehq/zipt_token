...
const PausableToken = artifacts.require('ZipTokenMock');
...
contract('PausableToken', function ([_, owner, recipient, anotherAccount]) {
  ...
  describe('pause', function () {
    ...
    describe('when the sender is not the token owner', function () {
      ...
      it('reverts', async function () {
        await assertRevert(this.token.pause({ from: anotherAccount }));
      });
    });
  });
  ...
  describe('unpause', function () {
    ...
    describe('when the sender is not the token owner', function () {
      ...
      it('reverts', async function () {
        await assertRevert(this.token.unpause({ from: anotherAccount }));
      });
    });
  });
  ...
  describe('pausable token', function () {
    ...
    describe('paused', function () {
      it('is not paused by default', async function () {
        const paused = await this.token.paused({ from: owner });
